    ...
    <div className="min-h-screen flex items-center justify-center gradient-dark p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">WSL Chat</h1>
          <p className="text-secondary-400 mt-2">Sign in to your workspace</p>
        </div>

        {/* Login Form */}
        <div className="bg-white dark:bg-secondary-800 rounded-2xl shadow-2xl p-8 border border-secondary-200 dark:border-secondary-700">
          ...
          <button
            ...
            onClick={async () => {
              try {
                // Auth handlers return { success, url } directly (not wrapped in data)
            ...
            className="btn-ghost btn-lg w-full border-2 border-secondary-200 dark:border-secondary-700 hover:border-secondary-300 dark:hover:border-secondary-600"
          >
